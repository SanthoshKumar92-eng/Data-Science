...
classification_report(y_test,y_predict) #Acc 66
...
classification_report(y_test,y_pred) #Acc 66
#probabality
from sklearn import metrics
from sklearn.metrics import auc
...
metrics.accuracy_score(y_test,y_pred1) #Acc 76
...
dt=DecisionTreeClassifier(max_depth=4,min_samples_leaf=1,random_state=0)
...
classification_report(y_test,y_predB) # ACC 80
