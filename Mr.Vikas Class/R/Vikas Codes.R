...
st_prod
# ggboxplot(st_prod, x = "Poject", y = "Productivity",
# color = "group", palette = c("#00AFBB", "#E7B800", "#FC4E07","#FC4E80"),
# order = c("Project.1", "Project.2", "Project.3","Project.4"),
# ylab = "Productivity", xlab = "Project")
# Box plot
...
library(gplots)
plotmeans(Productivity ~ Project, data = st_prod, frame = FALSE,
          xlab = "Project", ylab = "Productivity",
