...
# 1. KNN= 76.3 test accuracy

#2.random forest test accuracy is 75.35
#train accurcy is 81.6


#3.DT,accuracy 72.5..with pruning ,9 terminal nodes
#DT pruned train accuracy is 86%


 #4.DT test accuracy 72% ..withour pruning. 23 terminal nodes
 # DT train accuracy is 87.9%


#5.log reg test acc is 76.3 with 0.3 threshold
#log reg train acc is 80.7% with 0.3 threshold
